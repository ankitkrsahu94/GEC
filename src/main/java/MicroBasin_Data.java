...
public class MicroBasin_Data {
	...
	MicroBasin_Data(MicroBasin basin){
		...
		setArea(basin.area);
		this.loc_association=basin.loc_association;
		this.geological_info=basin.geological_info;
		this.infiltration_info=basin.infiltration_info;
		this.resource_distribution=basin.resource_distribution;
